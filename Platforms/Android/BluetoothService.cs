...
using Device = Plugin.BLE.Android.Device;
...
#nullable enable
    ...
    static UUID? _myUuidSecure = UUID.FromString("00001101-0000-1000-8000-00805F9B34FB");
    ...
    public Task Connect(string deviceName)
    {
        ...
        {
            throw new DeviceConnectionException(Guid.Empty, deviceName, ex.Message);
        }
        return Task.CompletedTask;
    }
